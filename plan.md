...
| 9 — Off-policy learning | `feat/offpolicy-study` | 🔄 In progress | Double DQN, scratch and BC-initialized, on the two correlated cells — completes the {PPO, DQN} × {scratch, BC-init} 2×2: does off-policy value learning find and/or keep the switching policy PPO destroys? |
